...
assert.doesNotMatch(html, /data-cc-tab/);
assert.match(html, /function renderAuditoria\(/);
assert.match(html, /function renderSecurityPanel\(/);
assert.match(html, /function selectSecurityTab\(/);
assert.match(html, /function renderPermisos\(/);
assert.match(html, /id="securityApp"/);
...
assert.doesNotMatch(html, /Equipo confirmado/);
